...
public class JsonCompareTask extends AbstractTask{
        ...
        try {
            ...
            while (sum < MAX){
                ...
                if (leftIndex >= leftJsons.length && rightIndex < rightJsons.length){
                    ...
                    comparativeText(stack, leftDocument, rightDocument, leftJsons, rightJsons, leftIndex, rightIndex);
                }
                sum++;
            }
        }catch (Exception e){
     ...
     */
    private void comparativeText(Stack<String> stack,Document leftDocument,Document rightDocument,String[] leftJsons,String[] rightJsons,int leftIndex,int rightIndex) throws BadLocationException {
